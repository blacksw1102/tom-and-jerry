...
public class WaitingRoom extends JPanel {
	...
	public WaitingRoom() {
		...
		lblNewLabel.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 18));
		lblNewLabel.setBounds(14, 12, 74, 36);
		panel.add(lblNewLabel);
		
		JLabel label = new JLabel("\uD14C\uC2A4\uD2B8 \uBC29 \uC81C\uBAA9");
		label.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 18));
		label.setBounds(76, 12, 397, 36);
		panel.add(label);
		
		JButton btnNewButton_1 = new JButton("\uBC29 \uC81C\uBAA9\uBCC0\uACBD");
		btnNewButton_1.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 18));
		...
		label_8.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		label_9.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		label_10.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		label_11.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		label_12.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		label_13.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		textArea.setFont(new Font("µ¸¿ò", Font.PLAIN, 15));
		...
		btnNewButton.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 18));
		btnNewButton.setBounds(738, 528, 390, 70);
		add(btnNewButton);
		
		JButton button = new JButton("\uB098\uAC00\uAE30");
		button.setBackground(Color.WHITE);
		button.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 18));
		button.setBounds(738, 610, 390, 70);
		add(button);
		
		textField = new JTextField();
		textField.setFont(new Font("µ¸¿ò", Font.PLAIN, 15));
		textField.setBounds(128, 645, 500, 35);
		add(textField);
		textField.setColumns(10);
		
		JButton btnNewButton_2 = new JButton("\uC785\uB825");
		btnNewButton_2.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
